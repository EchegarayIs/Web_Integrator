...
<div class="main-wrapper">
    ...
    <div class="login-section">
        ...
        <form action="../controller/dispacher.php" method="POST" class="form-box">
            ...
            <input type="hidden" id="accion" name="accion" value="LoginAdmin">
    ...
    <div class="overlay-container">
        <div class="overlay-content">
            <div class="side-panel side-right">
                <h1>Administrador</h1>
                <p>Capacidad de gestión académica general, consulta tu información y actividades; con privilegios de administración.</p>
            </div>
        </div>
    </div>
